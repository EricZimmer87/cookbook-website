...
CREATE TABLE ingredients (
  ...
  UNIQUE KEY ux_ingredients_name (ingredient_name)   -- unique by name
)
ENGINE=InnoDB
...
INSERT INTO users (user_id, role_id, user_name, user_email, password_hash, is_banned)
VALUES (1, 1, 'Eric Zimmer', 'cookbook-website@ejzimmer.com', '$2a$10$rcHeJ2PGa6bhaoJ4CScfQuFbtcynOQSpGsk.FMiC8p/keLYX5hwLO', 0);
...
INSERT INTO recipes (category_id, difficulty_id, user_id, recipe_instructions, recipe_name, ingredients_notes)
VALUES
...
'Nutty Green Bean Casserole', null);
...
'Pumpkin Pie, Healthy', 'Can use 4 medjool dates or 8 regular dates for the crust.');

-- recipe 4: ketchup
INSERT INTO recipes (category_id, difficulty_id, user_id, recipe_instructions, recipe_name, ingredients_notes)
VALUES
(3, 3, 1, 'Blend all ingredients in a high-powered blender.',
'Ketchup', 'If using medjool dates, use 7. 12 oz tomato paste is two small (6 oz) cans.');
...
'Eric''s Bean Burgers', 'Can use one can of garbanzo beans. Can substitute shredded carrots with shredded zucchini.');
